...
process.ttHLeptons = cms.EDProducer("LeptonIdentifier",
    electronMinPt = cms.double(7.0),
    electrons = cms.InputTag("slimmedElectrons"),
    jets = cms.InputTag("slimmedJets"),
    muonMinPt = cms.double(5.0),
    muons = cms.InputTag("slimmedMuons"),
    rhoParam = cms.InputTag("fixedGridRhoFastjetCentralNeutral"),
...
process.ttHtaus = cms.EDAnalyzer("CU_ttH_EDA",
    ...
    HLT_electron_electron_triggers = cms.vstring('HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v1'),
    HLT_electron_muon_triggers = cms.vstring('HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v1', 
        'HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v1'),
    HLT_electron_triggers = cms.vstring('HLT_Ele27_eta2p1_WP75_Gsf_v1'),
    HLT_muon_muon_triggers = cms.vstring('HLT_Mu30_TkMu11_v1', 
        'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v1', 
        'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v1'),
    HLT_muon_triggers = cms.vstring('HLT_IsoMu24_eta2p1_v1'),
    ...
    min_ele_pT = cms.double(7.0),
    min_jet_pT = cms.double(25.0),
    min_mu_pT = cms.double(5.0),
    min_nbtags = cms.int32(1),
    min_njets = cms.int32(2),
    min_tau_pT = cms.double(20.0),
...
process.p = cms.Path(process.electronMVAValueMapProducer+process.ttHLeptons+process.ttHtaus)
