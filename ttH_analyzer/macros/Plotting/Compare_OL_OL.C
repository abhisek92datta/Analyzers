...
void Compare_OL_OL() {
    ...
    TFile *f1 = new TFile("Distribution_mc_ttjets_ol.root");
    ...
    */
    ...
    double factor_ttjets_pp = 1.0;
    double sigma_ttjets_pp = 25.9; // pb
    double N_total_ttjets_pp = 19659611;
    double sum_gen_weight_ttjets_pp = 1.76729e+12;
    double norm_ttjets_pp = (L*sigma_ttjets_pp*1000)/(sum_gen_weight_ttjets_pp);
    double scale_ttjets_pp = factor_ttjets_pp*norm_ttjets_pp;
    ...
    double N_total_ttjets_ol = 19659611;
    double sum_gen_weight_ttjets_ol = 1.76729e+12;
...
/*
    ...
    for(int i=0; i<n_e; i++){
        ...
        leg1->AddEntry(ttjets_pp_e[i],"MC : Background OpenLoops-Sherpa all","L");
        leg1->AddEntry(ttjets_ol_e[i],"MC : Background OpenLoops-Sherpa ttbb","L");
    ...
    for(int i=0; i<n_mu; i++){
        ...
        leg1->SetFillColor(kWhite);
        leg1->SetFillStyle(1001);
        leg1->AddEntry(ttjets_pp_mu[i],"MC : Background OpenLoops-Sherpa all","L");
        leg1->AddEntry(ttjets_ol_mu[i],"MC : Background OpenLoops-Sherpa ttbb","L");
    ...
    for(int i=0; i<n_ee; i++){
        ...
        leg1->SetFillColor(kWhite);
        leg1->SetFillStyle(1001);
        leg1->AddEntry(ttjets_pp_ee[i],"MC : Background OpenLoops-Sherpa all","L");
        leg1->AddEntry(ttjets_ol_ee[i],"MC : Background OpenLoops-Sherpa ttbb","L");
    ...
    for(int i=0; i<n_emu; i++){
        ...
        leg1->SetFillColor(kWhite);
        leg1->SetFillStyle(1001);
        leg1->AddEntry(ttjets_pp_emu[i],"MC : Background OpenLoops-Sherpa all","L");
        leg1->AddEntry(ttjets_ol_emu[i],"MC : Background OpenLoops-Sherpa ttbb","L");
    ...
    for(int i=0; i<n_mumu; i++){
        ...
        leg1->SetFillColor(kWhite);
        leg1->SetFillStyle(1001);
        leg1->AddEntry(ttjets_pp_mumu[i],"MC : Background OpenLoops-Sherpa all","L");
        leg1->AddEntry(ttjets_ol_mumu[i],"MC : Background OpenLoops-Sherpa ttbb","L");
...
*/
    ...
    for(int i=0; i<n_e; i++){
        ...
        ttjets_pp_e[i]->SetLineColor(kRed);
        ttjets_pp_e[i]->SetLineWidth(2);
        ttjets_pp_e[i]->DrawNormalized("same");

        ttjets_ol_e[i]->SetLineColor(kGreen+3);
        ttjets_ol_e[i]->SetLineWidth(3);
        ttjets_ol_e[i]->DrawNormalized("same");

         //data_e[i]->SetLineColor(kBlue);
         //data_e[i]->SetLineWidth(2);
         //data_e[i]->DrawNormalized("same");
    ...
    for(int i=0; i<n_mu; i++){
        ...
        ttjets_pp_mu[i]->SetLineColor(kRed);
        ttjets_pp_mu[i]->SetLineWidth(2);
        ttjets_pp_mu[i]->DrawNormalized("same");

        ttjets_ol_mu[i]->SetLineColor(kGreen+3);
        ttjets_ol_mu[i]->SetLineWidth(3);
        ttjets_ol_mu[i]->DrawNormalized("same");

         //data_mu[i]->SetLineColor(kBlue);
         //data_mu[i]->SetLineWidth(2);
         //data_mu[i]->DrawNormalized("same");
    ...
    for(int i=0; i<n_ee; i++){
        ...
        ttjets_pp_ee[i]->SetLineColor(kRed);
        ttjets_pp_ee[i]->SetLineWidth(2);
        ttjets_pp_ee[i]->DrawNormalized("same");

        ttjets_ol_ee[i]->SetLineColor(kGreen+3);
        ttjets_ol_ee[i]->SetLineWidth(3);
        ttjets_ol_ee[i]->DrawNormalized("same");

         //data_ee[i]->SetLineColor(kBlue);
         //data_ee[i]->SetLineWidth(2);
         //data_ee[i]->DrawNormalized("same");
    ...
    for(int i=0; i<n_emu; i++){
        ...
        ttjets_pp_emu[i]->SetLineColor(kRed);
        ttjets_pp_emu[i]->SetLineWidth(2);
        ttjets_pp_emu[i]->DrawNormalized("same");

        ttjets_ol_emu[i]->SetLineColor(kGreen+3);
        ttjets_ol_emu[i]->SetLineWidth(3);
        ttjets_ol_emu[i]->DrawNormalized("same");

         //data_emu[i]->SetLineColor(kBlue);
         //data_emu[i]->SetLineWidth(2);
         //data_emu[i]->DrawNormalized("same");
    ...
    for(int i=0; i<n_mumu; i++){
        ...
        ttjets_pp_mumu[i]->SetLineColor(kRed);
        ttjets_pp_mumu[i]->SetLineWidth(2);
        ttjets_pp_mumu[i]->DrawNormalized("same");

        ttjets_ol_mumu[i]->SetLineColor(kGreen+3);
        ttjets_ol_mumu[i]->SetLineWidth(3);
        ttjets_ol_mumu[i]->DrawNormalized("same");

         //data_mumu[i]->SetLineColor(kBlue);
         //data_mumu[i]->SetLineWidth(2);
         //data_mumu[i]->DrawNormalized("same");
