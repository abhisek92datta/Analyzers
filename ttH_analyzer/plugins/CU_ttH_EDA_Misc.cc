...
void
CU_ttH_EDA::fillCSVHistos(TFile *fileHF, TFile *fileLF)
{
...
double
CU_ttH_EDA::getCSVWeight(std::vector<double> jetPts, std::vector<double> jetEtas, std::vector<double> jetCSVs,
